        ...
        <div class="modal-content" onclick="event.stopPropagation()">
            <div class="modal-header-row">
                <div class="modal-title-block">
                    ...
                    <div id="modalAccesses" class="modal-accesses" style="color: #229ED9; margin-top: 5px; font-weight: 600; font-size: 0.9rem;">⚡ ${Math.floor(Math.random() * 700) + 300} Novos Acessos Hoje!</div>
                </div>
