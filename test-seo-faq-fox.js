...
const seoBlock = `
                ...
                <div class="seo-faq-section mt-5 pt-4 text-start" style="border-top: 1px solid #222;">
                    ...
                    <div style="margin-bottom: 12px;">
                        <strong style="color: #bbb; font-size: 0.85rem; display: block; margin-bottom: 2px;">Como acessar o grupo Amanda Fox?</strong>
                        <p style="color: #666; font-size: 0.8rem; line-height: 1.4; margin: 0;">O link oficial e seguro para entrar no canal do Telegram e WhatsApp da Amanda Fox está disponível no botão verde acima. Clique para ser redirecionado imediatamente.</p>
                    </div>
                    ...
                    <div style="margin-bottom: 0;">
                        ...
                        <p style="color: #666; font-size: 0.8rem; line-height: 1.4; margin: 0;">Sim. Para manter a qualidade do material VIP da Amanda Fox, exigimos respeito absoluto entre todos os membros inscritos. Menores de 18 anos são terminantemente proibidos.</p>
                    </div>
                </div>
`;
...
if (!html.includes('seo-faq-section')) {
    ...
    console.log('✅ Injected prototype SEO FAQ into Amanda Fox');
} else {
