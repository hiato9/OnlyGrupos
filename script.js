...
function renderPagination(totalPages) {
    ...
    prevBtn.innerHTML = '«'; // Double arrow
    ...
    nextBtn.innerHTML = '»'; // Double arrow
...
function getCategoryIcon(cat) {
    const icons = {
        'Cdzinhas': '😈', // generic evil smile or similiar
        'Gays': '🏳️‍🌈',
        'Cornos': '🐂',
        'Putaria 24h': '🔞',
        'Modelos': '📸',
...
function openModal(group) {
    ...
    // Views Logic matching request "⚡ 727 Novos Acessos Hoje!" (limit 600)
...
const sponsoredGroups = [
    ...
    },
    {
        ...
        desc: "O acervo secreto das famosas que você sempre quis ver. Atualizado todo dia com novidades.",
        badges: ["HOT"],
        btnText: "VER CONTEÚDO",
        link: "#",
        emoji: "🔞"
    },
    {
        title: "DESAFIOS TIKTOK",
        desc: "Os vídeos mais virais e proíbidos do TikTok que não podem ser postados lá.",
        badges: ["VIRAL"],
